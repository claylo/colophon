...
const ENV_LOG_PATH: &str = "COLOPHON_LOG_PATH";
const ENV_LOG_DIR: &str = "COLOPHON_LOG_DIR";
...
mod tests {
    ...
    fn log_target_from_path_uses_parent_dir() {
        let temp_dir = std::env::temp_dir().join("colophon-log-path");
    ...
    fn log_target_from_dir_appends_file_name() {
        let temp_dir = std::env::temp_dir().join("colophon-log-dir");
    ...
    fn resolve_log_target_with_prefers_path_override() {
        let temp_dir = std::env::temp_dir().join("colophon-log-override");
    ...
    fn resolve_log_target_with_falls_back_to_dir_override() {
        let temp_dir = std::env::temp_dir().join("colophon-log-dir-override");
    ...
    fn resolve_log_target_with_uses_config_dir() {
        let temp_dir = std::env::temp_dir().join("colophon-log-config-dir");
