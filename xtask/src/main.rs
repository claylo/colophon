//! Build automation tasks for colophon.
//!
...
enum Task {
    /// Generate shell completions for the colophon CLI.
    Completions(commands::completions::CompletionsArgs),

    /// Generate manpages for the colophon CLI.
    Man(commands::man::ManArgs),

    /// Build and install the colophon CLI into ~/.bin for local testing.
